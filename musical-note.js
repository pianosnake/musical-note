...
<svg id="svgImage" width="75" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  class MusicalNote extends HTMLElement {
    connectedCallback() {
      ...
      this.note = new Note(value, this.preferFlatName);
    ...
    _draw() {
      const viewBox = getViewBox(this.height);
      this.$.svgImage.setAttribute("viewBox", viewBox);
